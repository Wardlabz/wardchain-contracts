...
impl EngagementContract {
    ...
    pub fn claim_escrow_earnings(
        ...
        let wardchain_commission = (total_amount * 0.003).floor() as i128; 
        let platform_commission = (total_amount * platform_fee_percentage as f64).floor() as i128;
        
        let wardchain_address = Address::from_string(&soroban_sdk::String::from_str(&e, "GBPUACN7QETR4TCYTKINBDHTYTFXD3BQQQV7VSMZC5CX74E4MTUL2AMUB"));
        ...
        let service_provider_amount = (total_amount - wardchain_commission as f64 - platform_commission as f64).floor() as i128;
